...
WORKSPACE_GIT_ENABLED_ENV = "HERMES_WEBUI_WORKSPACE_GIT_ENABLED"
_GIT_ENV_SCRUB_KEYS = (
    "GIT_DIR",
    "GIT_WORK_TREE",
    "GIT_CONFIG_GLOBAL",
...
def workspace_git_enabled() -> bool:
    return os.getenv(WORKSPACE_GIT_ENABLED_ENV, "1").strip().lower() not in {
        "0",
        "false",
        "no",
        "off",
