...
from agent.explore.mindsearch_hitl_agent.mindsearch_agent_v3_drug_manual_prompt import (
    drug_manual_thinking_sys_pt, drug_manual_final_output_sys_pt,
)
...
class MindSearchDrugManualThinkingAgent(AgentPreset):
...
class MindSearchDrugManualHitlAgent(MindSearchAgentV3):

    thinking_agent: MindSearchDrugManualThinkingAgent = MindSearchDrugManualThinkingAgent()
    ...
    def _format_thinking_prompt(
        ...
        return drug_manual_thinking_sys_pt, user_prompt
    ...
    async def _format_final_output_prompt(
        ...
        return drug_manual_final_output_sys_pt, final_user_prompt
