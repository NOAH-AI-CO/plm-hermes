...
from agent.explore.mindsearch_hitl_agent.mindsearch_agent_v3_web_prompt import (
    web_thinking_sys_pt, web_final_output_sys_pt,
)
from tools.explore.mindsearch_tools_v3 import (
    DocumentReader, GeneralSearch, DocumentSearchFinished
)
...
class MindSearchWebThinkingAgent(AgentPreset):
...
class MindSearchWebHitlAgent(MindSearchAgentV3):
    
    thinking_agent: MindSearchWebThinkingAgent = MindSearchWebThinkingAgent()
    ...
    def _format_thinking_prompt(
        ...
        return web_thinking_sys_pt, user_prompt
    ...
    async def _format_final_output_prompt(
        ...
        return web_final_output_sys_pt, final_user_prompt
