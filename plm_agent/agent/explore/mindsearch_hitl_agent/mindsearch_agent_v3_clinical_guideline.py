...
from agent.explore.mindsearch_hitl_agent.mindsearch_agent_v3_clinical_guideline_prompt import (
    clinical_guideline_thinking_sys_pt, clinical_guideline_final_output_sys_pt,
)
...
class MindSearchClinicalGuidelineThinkingAgent(AgentPreset):
...
class MindSearchClinicalGuidelineHitlAgent(MindSearchAgentV3):

    thinking_agent: MindSearchClinicalGuidelineThinkingAgent = MindSearchClinicalGuidelineThinkingAgent()
    ...
    def _format_thinking_prompt(
        ...
        return clinical_guideline_thinking_sys_pt, user_prompt
    ...
    async def _format_final_output_prompt(
        ...
        return clinical_guideline_final_output_sys_pt, final_user_prompt
