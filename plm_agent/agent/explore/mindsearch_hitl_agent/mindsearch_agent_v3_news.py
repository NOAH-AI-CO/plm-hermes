...
from agent.explore.mindsearch_hitl_agent.mindsearch_agent_v3_news_prompt import (
    news_thinking_sys_pt, news_final_output_sys_pt,
)
from tools.explore.mindsearch_tools_v3 import (
    GeneralSearch, NewsSearch,
...
class MindSearchNewsThinkingAgent(AgentPreset):
...
class MindSearchNewsHitlAgent(MindSearchAgentV3):
    
    thinking_agent: MindSearchNewsThinkingAgent = MindSearchNewsThinkingAgent()
    ...
    def _format_thinking_prompt(
        ...
        return news_thinking_sys_pt, user_prompt
    ...
    async def _format_final_output_prompt(
        ...
        return news_final_output_sys_pt, final_user_prompt
