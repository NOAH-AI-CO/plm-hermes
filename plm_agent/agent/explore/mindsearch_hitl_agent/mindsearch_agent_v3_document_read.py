...
from llm.azure_models import GPT54Mini, GPT5
...
from agent.explore.mindsearch_hitl_agent.mindsearch_agent_v3_document_read_prompt import (
    document_read_thinking_sys_pt, document_read_final_output_sys_pt,
)
from tools.explore.mindsearch_tools_v3 import (
    GeneralSearch, DocumentSearch,
...
class MindSearchReadingFilesThinkingAgent(AgentPreset):
...
class MindSearchDocumentReadHitlAgent(MindSearchAgentV3):
    
    thinking_agent: MindSearchReadingFilesThinkingAgent = MindSearchReadingFilesThinkingAgent()
    ...
    def _format_thinking_prompt(
        ...
        return document_read_thinking_sys_pt, user_prompt
    ...
    async def _format_final_output_prompt(
        ...
        return document_read_final_output_sys_pt, final_user_prompt
