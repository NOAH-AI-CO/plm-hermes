...
toc_builder_prompt = """
Help me construct a table of contents for a investigator-initiated trial protocol document page by page. There are in total {total_pages} pages.
<TOC In Progress>
{toc}
</TOC In Progress>
<Next Pages>
...
async def run_on_path(path, obj):
    try:
        toc = ""
        text = None
